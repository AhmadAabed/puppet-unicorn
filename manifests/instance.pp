...
# Configuring component service
	supervisor::service{"salamweb":
		...
		environment => "PATH='/usr/local/rvm/gems/ruby-1.9.3-p392@salamweb/bin:/usr/local/rvm/gems/ruby-1.9.3-p392@global/bin:/usr/local/rvm/rubies/ruby-1.9.3-p392/bin:/usr/local/rvm/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games'",
		user	=> "salamweb",
		group  	=> "salamweb",
